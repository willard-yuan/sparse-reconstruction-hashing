function evaluation_info=evaluate_SH(Xtraining,Xtest,KNN_info,Param)

tmp_T=cputime;
Param = trainSH(Xtraining, Param);
traintime=cputime-tmp_T;
evaluation_info.trainT=traintime;

tmp_T=cputime;
[B_trn, U] = compressSH(Xtraining, Param);
[B_tst, U] = compressSH(Xtest, Param);
